...
//        RestAssured.filters(new RequestLoggingFilter(), new ResponseLoggingFilter());
    ...
    void deveRetornarBadRequestAoTentarReservarImovelComReservaAtivaNoPeriodo() {
        Periodo periodoExistenteNoBanco = PeriodoFixture
            .get()
            .valido()
            .comDataHoraFinal(LocalDateTime.of(2021, 1, 6, 12,0,0))
            .comDataHoraInicial(LocalDateTime.of(2021, 1, 1, 14,0,0))
            .build();

        CadastrarReservaRequest reservadaParaOPeriodo = CadastrarReservaRequestFixture
            .get()
            .valido()
            .comIdAnunciante(1)
            .comIdSolicitante(2)
            .comPeriodo(periodoExistenteNoBanco)
            .build();

        given()
            .contentType(ContentType.JSON)
            .body(reservadaParaOPeriodo)
        .when()
            .post(BASE_PATH)
        .then()
            .assertThat()
